    ...
    int       nCmdShow)
{
    ...
    return TabelviewPlayer::createAndRun();
}

int TabelviewPlayer::createAndRun(void)
{
    TabelviewPlayer *host = TabelviewPlayer::sharedInstance();
    int ret = host->run();
    TabelviewPlayer::purgeSharedInstance();
    return ret;
}

TabelviewPlayer *TabelviewPlayer::s_sharedInstance = NULL;

TabelviewPlayer *TabelviewPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new TabelviewPlayer();
    }
    return s_sharedInstance;
}

void TabelviewPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
TabelviewPlayer::TabelviewPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int TabelviewPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "tabelview-player");
...
void TabelviewPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void TabelviewPlayer::createViewMenu(void)
{
...
void TabelviewPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void TabelviewPlayer::updateWindowTitle(void)
{
}

void TabelviewPlayer::relaunch(void)
{
...
void TabelviewPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void TabelviewPlayer::onFileOpenProject(void)
{
...
void TabelviewPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"TabelviewPlayer");
...
void TabelviewPlayer::onFileProjectConfig(void)
{
...
void TabelviewPlayer::onFileRelaunch(void)
{
    relaunch();
}

void TabelviewPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void TabelviewPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void TabelviewPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void TabelviewPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void TabelviewPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT TabelviewPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    TabelviewPlayer *host = TabelviewPlayer::sharedInstance();
...
INT_PTR CALLBACK TabelviewPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
